...
from modules.Utility.ui import HelpUi
from core.utils.openai_utils import get_chat_completion


class UtilityCog(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.guild_settings_collection:AsyncIOMotorCollection = Database.guild_settings()
        self.last_seen_collection:AsyncIOMotorCollection = Database.last_seen()
